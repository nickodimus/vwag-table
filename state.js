...
const controls = {
  ...
  aoeSelRename: document.getElementById("aoeSelRename"),
  aoeSelColor: document.getElementById("aoeSelColor"),
  aoeSelSize: document.getElementById("aoeSelSize"),
  aoeSelAngleRow: document.getElementById("aoeSelAngleRow"),
  aoeSelAngleSlider: document.getElementById("aoeSelAngleSlider"),
  ...
  aoeNameDialog: document.getElementById("aoeNameDialog"),
  aoeNameInput: document.getElementById("aoeNameInput"),
  ...
  loadFallon: document.getElementById("loadFallon"),
  fallonDialog: document.getElementById("fallonDialog"),
  fallonMapList: document.getElementById("fallonMapList"),
  fallonMapSize: document.getElementById("fallonMapSize"),
  publishFallon: document.getElementById("publishFallon"),
  pullFallon: document.getElementById("pullFallon"),
  inviteFallon: document.getElementById("inviteFallon"),
  ...
  mapLinkSelPanel: document.getElementById("mapLinkSelPanel"),
  mapLinkSelTarget: document.getElementById("mapLinkSelTarget"),
  mapLinkSelIconGrid: document.getElementById("mapLinkSelIconGrid"),
  mapLinkSelLabel: document.getElementById("mapLinkSelLabel"),
  mapLinkSelDelete: document.getElementById("mapLinkSelDelete"),
